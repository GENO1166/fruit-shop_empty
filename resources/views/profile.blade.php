                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" class="form-control with-icon"
                                            value="" placeholder="08x-xxx-xxxx">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="current_password" class="form-control with-icon"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="new_password" class="form-control with-icon"
