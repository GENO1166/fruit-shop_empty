    ...
    <div class="container-box">
        <div class="table-header">
            <h2><i class="bi bi-people-fill me-2"></i> จัดการสมาชิกระบบ</h2>
                ...
                <a href="#" class="btn-add">+ เพิ่มสมาชิกใหม่</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-size: 13px;">
                                <i class="bi bi-envelope text-muted me-1"></i><br>
                                <i class="bi bi-telephone text-muted me-1"></i>
                            </div>
                        </td>
                        <td>
                            <div style="display: flex; justify-content: center; gap: 10px;">
                                <a href="#" class="btn-action btn-edit" title="แก้ไข">
                                    <i class="bi bi-pencil-square"></i>
                                </a>

                                <form action="#" method="POST" onsubmit="return confirm('ยืนยันการลบสมาชิกรายนี้?')">
                                    @csrf
                                    @method('DELETE')
